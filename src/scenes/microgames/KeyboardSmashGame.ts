...
export default class KeyboardSmashGame extends BaseMicrogame {
    ...
    setupGame(): void {
        ...
        this.targetKeys = Math.floor(10 + (5 * this.gameState.speed));

        // Create progress bar
        this.progressBarBg = this.add.rectangle(GAME_WIDTH / 2, 120, 400, 30, 0x000000, 0.3);
        this.progressBar = this.add.rectangle(GAME_WIDTH / 2 - 200, 120, 0, 30, COLORS.success);
        this.progressBar.setOrigin(0, 0.5);

        this.progressText = this.add.text(
            GAME_WIDTH / 2, 
            120, 
            `0/${this.targetKeys} KEYS`, 
            { 
                fontSize: '24px', 
                color: '#ffffff',
                fontFamily: 'Arial',
        ...
        this.add.text(
            GAME_WIDTH / 2, 
            80, 
            `Hit ${this.targetKeys} different keys!`, 
            { 
                fontSize: '28px', 
                color: '#ffffff',
                fontFamily: 'Arial',
    ...
    setupControls(): void {
        this.keyboardListener = (event: KeyboardEvent) => {
            ...
            if (!this.pressedKeys.has(key)) {
                ...
                if (this.pressedKeys.size >= this.targetKeys) {
                    this.setWinState();
    ...
    private updateProgress(): void {
        // Update progress bar
        const progress = this.pressedKeys.size / this.targetKeys;
        ...
        // Update text
        this.progressText.setText(`${this.pressedKeys.size}/${this.targetKeys} KEYS`);
